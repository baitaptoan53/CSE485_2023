                        ...
                        <?php
                            ...
                            while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_author.php?id='.$row['ma_tgia'].'&ten_tgia='.$row['ten_tgia'].'" class="btn btn-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="delete_author.php?id='.$row['ma_tgia'].'" class="btn btn-danger">
