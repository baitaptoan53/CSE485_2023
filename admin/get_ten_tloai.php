...
if (!isset($_POST['searchTerm'])) {
  ...
  $stmt = $pdo->prepare("select * from theloai order by ten_tloai limit :limit");
  ...
  $stmt = $pdo->prepare("SELECT * FROM theloai WHERE ten_tloai like :ten_tloai ORDER BY ten_tloai LIMIT :limit");
